...
def check_and_validate_args(  # noqa: C901
    ...
    return PixyArgs(
        ...
        interval_start=int(args.interval_start) if args.interval_start is not None else None,
        interval_end=int(args.interval_end) if args.interval_end is not None else None,
        sites=sites,

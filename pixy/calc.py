...
def calc_tajima_d(gt_array: GenotypeArray) -> TajimaDResult:
    ...
    # calculate denominator for Tajima's D as in scikit-allel
    # except count of alleles (n) is averaged over all sites and rounded as in ThetaRecov

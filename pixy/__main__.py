...
def main(args=None):
    ...
    def calc_dxy_window(window_pos_1):
        ...
        if len(pos_array[(pos_array > window_pos_1) & (pos_array
               < window_pos_2)]) == 0:
        ...
        return str(str(pop1) + '\t' + str(pop2) + '\t' + str(chromosome)
    ...
    def calc_pi_window(window_pos_1):
        ...
        return str(str(pop) + '\t' + str(chromosome) + '\t'
                   + str(window_pos_1) + '\t' + str(window_pos_2) + '\t'
